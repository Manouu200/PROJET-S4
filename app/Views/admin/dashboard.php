...
<?= $this->section('content') ?>
        ...
        <div class="chart-box glass-card animate-fade-in">
            ...
            <div class="card-body">
                <div class="quick-actions-grid">
                    ...
                    <a href="<?= base_url('admin/codes') ?>" class="action-item">
                        <i class="fa-solid fa-check-double"></i>
                        <span>Valider Codes</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <style>
        ...
        .pastel-gold .stat-icon { color: #f1c40f; }
        .pastel-gold .value { color: #d4ac0d; }
        ...
        .action-item {
            ...
            background: #f8fafc; border-radius: 15px; text-decoration: none; color: #4b5563;
            transition: all 0.3s ease; border: 1px solid transparent;
        }
        .action-item:hover {
            background: #ffffff; border-color: #6c5ce7; color: #6c5ce7;
            transform: translateY(-5px); box-shadow: 0 10px 20px rgba(108, 92, 231, 0.1);
        }
